                    ...
                    <table class="table table-bordred table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" wire:click='editBrand({{$brand->id}})' data-bs-toggle="modal" data-bs-target="#updateBrandModal" class="btn btn-success btn-sm" class="btn btn-sm btn-success">Edit</a>
