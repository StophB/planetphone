        ...
        <div class="container">
                                ...
                                <div class="cart-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 my-auto">
                                            <label class="price">{{ $cartItem->product->selling_price }} Dhs</label>
                                        </div>
                                        ...
                                        <div class="col-md-1 my-auto">
                                            <label class="price">{{ $cartItem->product->selling_price * $cartItem->quantity }} Dhs</label>
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h5>
                        Profitez des meilleures offres et promotions <a href="{{ url('/collections') }}">achetez maintenant</a>
                    </h5>
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        <h4>Total :
                            <span class="float-end">{{ $totalPrice }}Dhs</span>
                        </h4>
                        <hr>
                        <a href="{{ url('/checkout') }}" class="btn btn-warning w-100">Passer la commande</a>
                    </div>
                </div>
            </div>
