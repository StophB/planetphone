<div>
    <div class="row">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <label class="d-block">
                    <input type="radio" name="priceSort" wire:model="priceInput" value="high-to-low"> Élevé à Bas
                </label>
                <label class="d-block">
                    <input type="radio" name="priceSort" wire:model="priceInput" value="low-to-high"> Bas à Élevé
                </label>
            </div>
        </div>
    ...
    <div class="col-md-9">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="product-card">
                    <div class="product-card-img">
                        ...
                        @else
                        <label class="stock bg-danger">Rupture de stock</label>
                        @endif
            ...
            <div class="col-md-12">
                <div class="p-2">
                    <h4>Aucun produit disponible pour {{ $category->name }}</h4>
                </div>
            </div>
            @endforelse
        </div>
