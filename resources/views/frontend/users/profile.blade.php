...
<div class="py-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <h4>Profil de l'utilisateur
                    <a href="{{ url('change-password') }}" class="btn btn-warning float-end">Changer le mot de passe ?</a>
                </h4>
            ...
            <div class="col-md-10">
                ...
                <div class="card shadow">
                    <div class="card-header bg-primary">
                        <h4 class="mb-0 text-white">Détails de l'utilisateur</h4>
                    </div>
                    <div class="card-body">
