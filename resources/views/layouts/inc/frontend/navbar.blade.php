            ...
            <div class="row">
                <div class="col-md-3 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <a class="navbar-brand brand-logo" href="{{ url('/') }}">
                        <img src="{{  asset('assets/logo.png')}}" width="210" height="72">
                      </a>
                </div>
                    ...
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('wishlist') }}">
                                <i class="fa fa-heart"></i> liste de souhaits (<livewire:frontend.wishlist-count />)
                            </a>
                        </li>
                        @guest
                            @if (Route::has('login'))
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/collections') }}">Toutes catégories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/new-arrivals') }}">Nouvelles Arrivées</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/featured-products') }}">Produits populaires</a>
                    </li>
                </ul>
            </div>
        </div>
